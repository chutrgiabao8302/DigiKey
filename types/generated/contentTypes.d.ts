...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<['sold', 'expired', 'available']> &
...
export interface ApiProductTypeProductType extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description: Attribute.String;
    status: Attribute.Enumeration<['available', 'unavailable']> &
      Attribute.DefaultTo<'available'>;
    originalPrice: Attribute.Integer & Attribute.DefaultTo<0>;
    sellPrice: Attribute.Integer & Attribute.DefaultTo<0>;
    slug: Attribute.UID<'api::product-type.product-type', 'typeName'>;
...
export interface ApiSanPhamNoiBatSanPhamNoiBat extends Schema.CollectionType {
  collectionName: 'san_pham_noi_bats';
  info: {
    singularName: 'san-pham-noi-bat';
    pluralName: 'san-pham-noi-bats';
  ...
  attributes: {
    list: Attribute.Relation<
      'api::san-pham-noi-bat.san-pham-noi-bat',
      'oneToMany',
      'api::product-type.product-type'
    >;
    createdAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::san-pham-noi-bat.san-pham-noi-bat': ApiSanPhamNoiBatSanPhamNoiBat;
